 ...
 */
public class CustomInterpolatorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.view_interpolator:
                mViewInterpolator.startAnimation(new CustomInterpolator());
                break;
        }
    }
